...
const pricingPlans = [
    {
        ...
        price: "$99",
        period: "/month",
        description: "Simple chatbot to answer queries from your website or provided training data.",
        features: [
    ...
    },
    {
        ...
        price: "$199",
        period: "/month",
        description: "Everything in Basic plus lead capturing and contact form integration.",
        features: [
            "Everything in Basic",
    ...
    },
    {
        ...
        price: "$249",
        period: "/month",
        description: "Everything in Standard plus instant notifications and custom branding.",
        features: [
    ...
    },
    {
        ...
        price: "$499",
        period: "/month",
        description: "Everything in Advanced plus appointment booking and calendar sync.",
        features: [
            ...
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                        Start with our Basic plan and scale up as your business grows.
                        All plans include our core chatbot technology with additional features.
                    </p>
                </motion.div>
                    ...
                    {pricingPlans.map((plan, index) => (
                        ...
                        >
                            ...
                            <motion.div
                                ...
                                className={`relative h-full bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 lg:p-8 transition-all duration-300 ${plan.popular
